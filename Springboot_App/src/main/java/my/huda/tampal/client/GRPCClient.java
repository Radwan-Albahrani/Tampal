...
public class GRPCClient
{
    ...
    public static void main(String[] args)
    {
        ...
        // TODO create a user
        CreateUserRequest createUserRequest = CreateUserRequest.newBuilder().setUsername("username").setPassword("password")
        ...
        CreatePasteRequest createPasteRequest = CreatePasteRequest.newBuilder().setUserID(0)
                .setPaste(Paste.newBuilder().setPasteID(0).setText("paste").build())
                .build();
